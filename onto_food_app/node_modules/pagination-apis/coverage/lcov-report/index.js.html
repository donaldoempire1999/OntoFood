...
class Paginator {
  constructor(page, limit, defaultLimit = 10) {
    ...
    this.limit = !parseLimit ? <span class="branch-0 cbranch-no" title="branch not covered" >defaultLimit </span>: parseLimit;
    this.skip = (this.page &gt; 0 ? this.page - 1 : <span class="branch-1 cbranch-no" title="branch not covered" >this.page)</span> * this.limit;
  }
&nbsp;
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Mon Jul 20 2020 17:03:20 GMT-0300 (Argentina Standard Time)
            </div>
        </div>
